...
public class MapAnimator {
    ...
    static final int GREEN = Color.parseColor("#92b128");
    static final int LIGHT_GREEN = Color.parseColor("#a7c53a");
    ...
    public ArrayList<Polyline> animateRoute(GoogleMap googleMap, List<LatLng> bangaloreRoute) {
        ...
        PolylineOptions optionsBackground = new PolylineOptions().add(bangaloreRoute.get(0)).color(LIGHT_GREEN).width(10);
        backgroundPolyline = googleMap.addPolyline(optionsBackground);

        optionsForeground = new PolylineOptions().add(bangaloreRoute.get(0)).color(GREEN).width(10);
        ...
        percentageCompletion.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                foregroundPolyline.setColor(LIGHT_GREEN);
        ...
        ValueAnimator colorAnimation = ValueAnimator.ofObject(new ArgbEvaluator(), LIGHT_GREEN, GREEN);
...
//        foregroundRouteAnimator.start();
        ...
        polylineArrayList.add(backgroundPolyline);
        polylineArrayList.add(foregroundPolyline);
